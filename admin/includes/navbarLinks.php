...
<nav class="sidebarMod collapsed">
  ...
  <ul>
    <li><a href="<?php echo '/psms/admin/index.php'?>" class="<?php echo $current_page == 'index.php' ? 'active' : ''; ?>">
      <i class="fas fa-home"></i>
      <span class="nav-item">Dashboard</span>
      <span class="tooltip">Home</span>
    </a></li>
    <li><a href="<?php echo '/psms/admin/pages/userAccount.php'?>" class="<?php echo $current_page == 'userAccount.php' ? 'active' : ''; ?>">
      <i class="fas fa-users"></i>
      <span class="nav-item">User Account Management</span>
      <span class="tooltip">Profile</span>
    </a></li>
    <li><a href="<?php echo '/psms/admin/pages/userEvaluation.php'?>" class="<?php echo $current_page == 'userEvaluation.php' ? 'active' : ''; ?>">
