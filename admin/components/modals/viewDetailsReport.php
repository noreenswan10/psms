    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="userListModalLabel">
                    <span id="modalFnameInput"></span> <span id="modalLnameInput"></span>
                </h1>
                ...
                <form id="userForm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="mb-3 form-floating">
                            <input type="text" class="form-control" id="modalFnameInputField" placeholder="First Name">
                            <label for="modalFnameInputField" class="form-label">First Name</label>
                        </div>
                        <div class="mb-3 form-floating">
