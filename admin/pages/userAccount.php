...
<body>
  <div class="containerMod">
    ...
    <?php include ROOT_PATH . "/bppo/admin/includes/toasts/toastSuccess.php"; ?>
    <section class="mainMod">
      ...
      <div class="createUserBtn"><button class="btn" data-bs-toggle="modal" data-bs-target="#createUserModal">Create User</button></div>
          ...
          <tbody>
            <?php foreach ($users as $user): ?>
              <tr>
                ...
                <td><?php echo htmlspecialchars($user['lname']); ?>, <?php echo htmlspecialchars($user['fname']); ?> <?php echo htmlspecialchars($user['username']); ?></td>
  ...
  <!-- Create User Modal -->
  <?php include ROOT_PATH . "/bppo/admin/components/modals/createUserModal.php"; ?>                 
  ...
  <script>
   ...
   <script>
     <?php include ROOT_PATH . "/bppo/admin/js/createUserToast.js"; ?>   
  </script>
